...
function generateRandomName() {
    ...
    "Lucas", "William", "Benjamin", "Sebastian", "Jack", "Ezra", "Michael",
    "Daniel", "Leo", "Owen", "Samuel", "Olivia", "Emma", "Charlotte", "Amelia",
    "Sophia", "Mia", "Isabella", "Ava", "Evelyn", "Luna"
    ];
    const last = [
...
function generateBedTrauma() {
    const trauma = ["At risk", "Substance abuse", "Co-occuring disorders", "Sexual abuse survivors", "Human trafficking survivors"];
